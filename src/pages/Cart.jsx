...
const Cart = () => {
  ...
  // For checking the data is coming from home page to cart page or not
    ...
    <div className=' p-2 mt-4 w-6xl md:pt-3'>
      {
        ...
        (
          <div className='flex gap-10 justify-center flex-col lg:flex-row'>
            ...
            <div className="flex flex-col md:flex-col lg:flex-col justify-between max-h-[80vh] lg:w-1/4 gap-2">
              <div>
                ...
                <p className='font-bold mt-5'>Total Items : {cart.length} </p>
              </div>

              <div className='flex flex-col gap-3'>
                <p className='font-bold text-slate-600'>Total Amount : 
                <span className="className='text-black ml-1'">${totalAmount}</span></p>
                <button onClick={() => {
                  toast("This feature will be added soon" , { icon: '😊' })
        ...
        (
          <div className=' flex flex-col gap-4 justify-center items-center h-[calc(100vh-5rem)]'>
            <p className='font-bold tracking-wide'>Cart is Empty</p>
            <NavLink to={"/"}>
